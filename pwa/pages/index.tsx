...
import sendMessage from "../public/api-platform/send-message-svgrepo-com.svg";
import apiPicture from "../public/api-platform/api.svg";
import pgAdmin from "../public/api-platform/pgadmin.svg";
import rabbitMq from "../public/api-platform/rabbitmq-logo-svgrepo-com.svg";
      ...
      <div className="container | md:px-20">
        <div className="text-center | lg:text-left lg:w-3/5 lg:ml-auto">
          ...
          <div className="flex justify-center flex-wrap | lg:justify-start lg:grid lg:gap-5 lg:grid-cols-2">
            <SendMessage image={sendMessage}  />
            <Card image={pgAdmin} title="PgAdmin" target="_blank" url="http://localhost:5050/" />
            <Card image={rabbitMq} title="RebbitMQ" target="_blank" url="http://localhost:15673/" />
            <Card image={apiPicture} title="API" url="/docs" target="_self" />
            <Card image={adminPicture} title="Admin" url="/admin" target="_self" />
            <Card
              target="_self"
